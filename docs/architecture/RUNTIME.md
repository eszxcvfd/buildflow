...
- **Session state:** bearer opaque token lưu hash trong PostgreSQL sessions, revoke bằng xóa dòng (xem [`ADR-0005`](../adr/0005-opaque-session-tokens.md)); client chỉ consume trạng thái public.
