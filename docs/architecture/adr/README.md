...
| [ADR-012](ADR-012-testing-platform.md) | Automated Testing Strategy & Tooling | Accepted | 2026-09-02 | Backend: Jest/Supertest + real PostgreSQL 18.x (native or container locally; container in CI). Web: RTL + Playwright. Mobile: RNTL + Maestro. API contract tests. |
