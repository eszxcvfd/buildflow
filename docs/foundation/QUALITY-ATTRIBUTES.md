...
These measurable requirements come from SRS V2.1. They are delivery constraints, not optional implementation advice.
...
| NFR-SEC-003 | Must | Phân quyền Backend | Mỗi thao tác đọc/ghi phải kiểm tra quyền và project scope ở Backend; không tin cậy quyền từ UI. |
...
| NFR-CMP-002 | TBD | Nền tảng Mobile | Nhóm phải chốt Android-only hay Android+iOS trước thiết kế phát hành; baseline kỹ thuật đề xuất Android 10+. |
...
- NFR-CMP-002 remains TBD. No Mobile release claim may assume Android-only or Android+iOS until Q-14 is approved.
