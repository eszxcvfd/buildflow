...
import { EligibilityScreen } from '../src/features/eligibility/EligibilityScreen';
  ...
  if (!token) {
    return (
      <View style={styles.center}>
        <Text accessibilityRole="alert" style={styles.hint}>Vui lòng đăng nhập để xem điều kiện nhận việc</Text>
      </View>
    );
  }

  return <EligibilityScreen token={token} />;
}
