 ...
 * tra qua worker ACTIVE (fallback id rút gọn). Đổi trạng thái KHÔNG ở đây —
 * vòng đời dự án là PRJ-SRS-002. CTA 'Tạo dự án'/'Sửa hồ sơ' gated bởi
 * canManageProjects() (ADMIN + PROJECT_MANAGER, fail-closed).
 */
